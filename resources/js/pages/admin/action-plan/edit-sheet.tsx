...
export function EditSheet({
            ...
            setData({
                ...
                order_no:
                    plan.order_no !== undefined && plan.order_no !== null
                        ...
                        : '',
                responsible_unit_ids: plan.responsible_unit_ids ?? [],
            });
            setAssignToAll(
                units.length > 0 &&
    ...
    return (
        <Sheet open={open} onOpenChange={onOpenChange}>
            <SheetContent className="w-full overflow-y-auto p-5 sm:max-w-xl">
                <form
                ...
                >
                    ...
                    <div className="flex-1 space-y-3">
                        ...
                        {/* Order No and Dates Row */}
                        <div className="grid grid-cols-1 gap-3 sm:grid-cols-3">
                            <div className="space-y-1">
                                <Label
                                    htmlFor="edit-order_no"
                                    className="text-xs"
                                >
                                    Order No.
                                </Label>
                        ...
                        <div className="space-y-2 rounded-lg border bg-muted/20 p-2.5">
                            ...
                            <p className="text-[10px] text-muted-foreground italic">
                                Units that already submitted or were reviewed
                                won't be removed even if unchecked.
                            </p>
                        </div>
                    </div>
