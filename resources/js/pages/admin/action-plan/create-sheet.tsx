// resources/js/pages/admin/action-plan/create-dialog.tsx
...
export function CreateDialog({
    ...
    // Check if all units in a specific group are selected
                ...
                <form onSubmit={handleSubmit} className="space-y-3">
                    ...
                    <div className="grid grid-cols-1 gap-3 sm:grid-cols-12">
                        ...
                        <div className="space-y-1 sm:col-span-2">
                            <Label htmlFor="order_no" className="text-xs">
                                Order No.
                            </Label>
                            <Input
                                id="order_no"
