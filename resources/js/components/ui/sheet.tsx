    ...
    <SheetPortal>
      ...
      <SheetPrimitive.Content
        ...
        className={cn(
          ...
          // CHANGED: Expanded width to 85% of viewport width or 5xl max width
          "data-[side=right]:inset-y-0 data-[side=right]:right-0 data-[side=right]:h-full data-[side=right]:w-[85vw] data-[side=right]:border-l data-[side=right]:sm:max-w-5xl",
